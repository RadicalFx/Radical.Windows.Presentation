...
namespace Topics.Radical.Windows.Presentation.Boot
{
    ...
    public abstract class ApplicationBootstrapper : IServiceProvider
    {
        ...
        /// <param name="catalog">The catalog.</param>
        /// <param name="serviceProvider">The service provider.</param>
        protected virtual void ComposeCompositionContainer(CompositionContainer compositionContainer, AggregateCatalog catalog, IServiceProvider serviceProvider)
        {
        ...
        void OnBoot()
        {
            ...
            this.ComposeCompositionContainer(this.compositionContainer, this.catalog, this.serviceProvider);
